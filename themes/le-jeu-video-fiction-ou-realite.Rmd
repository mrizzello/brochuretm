...
_A. Morier et L. Moser_
:::

```{r le-jeu-video-fiction-ou-realite-2,echo=FALSE,out.height="7em",fig.show="hold",fig.align="right",fig.cap=""}
knitr::include_graphics(c("images/le-jeu-video-fiction-ou-realite-2.jpg"))
```
