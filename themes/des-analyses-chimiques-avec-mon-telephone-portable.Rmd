...
```{r analyses-chimiques-telephone-portable,echo=FALSE,out.height="12em",fig.show="hold",fig.align="center",fig.cap=""}
knitr::include_graphics(c("images/analyses-chimiques-telephone-portable.jpg"))
```
